...
for paquetes in libreoffice libreoffice-calc libreoffice-impress libreoffice-writer libreoffice-style-colibre libreoffice-style-colibre libreoffice-l10n-de libreoffice-l10n-es libreoffice-l10n-gl libreoffice-l10n-it libreoffice-l10n-pt libreoffice-l10n-fr; do sudo apt install -y $paquetes; done
...
function _pipewire() {
    ...
    for paquetes in libwireplumber-0.4-0 pipewire-audio-client-libraries wireplumber gstreamer1.0-pipewire libpipewire-0.3-0 libpipewire-0.3-modules pipewire pipewire-alsa pipewire-audio pipewire-bin pipewire-pulse; do sudo apt install -y $paquetes; done
...
function _firefoxBase() {

	# Carpetas de favoritos de Quirinux Base
 	for paquetes in quirinux-firefox-base; do sudo apt install -y $paquetes; done
...
function _firefoxAnimacion() {

	# Carpetas de favoritos de Quirinux Base
 	for paquetes in quirinux-firefox-animacion; do sudo apt install -y $paquetes; done
